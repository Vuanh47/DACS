...
public class TrangChu extends JFrame implements ActionListener{
	...
	public TrangChu() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TrangChu.class.getResource("/Image/avt.png")));
		...
		btnDanhSach.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/list.png")));
		...
		buttonThemBN.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/them.png")));
		...
		btnNewButton_CaNhan.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/user.png")));
		...
		btnNewButton_VienPhi.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/bill.png")));
		...
		lblNewLabel.setBounds(352, 7, 348, 73);
		...
		lblNewLabel_1.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/tk.png")));
		...
		btnNewButton_TimKiem.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/tim.png")));
		...
		btnNewButton_Huy.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/huy.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(TrangChu.class.getResource("/Image/boyte.png")));
